...
class SVGLoader extends Loader {
  ...
  Future<SVGData> loadAsync(url, [Function? onProgress, Function? onError]) async {
    final Completer<SVGData> completer = Completer();

    load(url, (SVGData result){
  ...
  static List<Shape> createShapes(ShapePath shapePath) {
    ...
    isHoleTo(simplePath, allPaths, scanlineMinX, scanlineMaxX, _fillRule) {
      ...
      final centerBoundingBox = Vector2();
