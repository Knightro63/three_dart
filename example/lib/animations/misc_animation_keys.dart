...
class MiscAnimationKeys extends StatefulWidget {
  MiscAnimationKeys({Key? key, required this.fileName}) : super(key: key);
...
class _State extends State<MiscAnimationKeys> {
  ...
  Future<void>initPage() async {
    ...
    //
    final axesHelper = three.AxesHelper(10);
    ...
    // POSITION
    final positionKF = three.VectorKeyframeTrack(
        '.position', [0, 1, 2], [0, 0, 0, 30, 0, 0, 0, 0, 0], null);

    // SCALE
    final scaleKF = three.VectorKeyframeTrack(
    ...
    final qFinal = three.Quaternion().setFromAxisAngle(xAxis, three.Math.pi);
