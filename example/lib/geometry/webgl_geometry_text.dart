...
class WebglGeometryText extends StatefulWidget {
  WebglGeometryText({Key? key, required this.fileName}) : super(key: key);
...
class _MyAppState extends State<WebglGeometryText> {
  ...
  Future<three.TYPRFont> loadFont() async {
    final loader = three_jsm.TYPRLoader();
    final fontJson = await loader.loadAsync("assets/pingfang.ttf");
    loader.dispose();
