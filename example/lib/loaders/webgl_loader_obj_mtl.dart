...
class WebglLoaderObjMtl extends StatefulWidget {
  WebglLoaderObjMtl({Key? key, required this.fileName}) : super(key: key);
...
class _MyAppState extends State<WebglLoaderObjMtl> {
  ...
  Future<void> initPage() async {
    ...
    final mtlLoader = three_jsm.MTLLoader(manager);
    mtlLoader.setPath('assets/models/obj/male02/');
    final materials = await mtlLoader.loadAsync('male02.mtl');
