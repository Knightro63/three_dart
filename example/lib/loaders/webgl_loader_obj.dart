...
class WebglLoaderObj extends StatefulWidget {
  WebglLoaderObj({Key? key, required this.fileName}) : super(key: key);
...
class _MyAppState extends State<WebglLoaderObj> {
  ...
  Future<void> initPage() async {
    ...
    texture = await textureLoader.loadAsync('assets/textures/uv_grid_opengl.jpg');
    ...
    final loader = three_jsm.OBJLoader();
