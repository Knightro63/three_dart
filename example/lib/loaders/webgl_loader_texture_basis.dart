...
class WebglLoaderTextureBasis extends StatefulWidget {
  WebglLoaderTextureBasis({Key? key, required this.fileName})
      : super(key: key);
...
class _MyAppState extends State<WebglLoaderTextureBasis> {
  ...
  Future<void> initPage() async {
    ...
    final material = three.MeshBasicMaterial({"side": three.DoubleSide});
    ...
    loader.flipY = true;
    final texture = await loader.loadAsync("assets/textures/758px-Canestra_di_frutta_(Caravaggio).jpg");
    loader.dispose();
