...
class WebglMaterialsBrowser extends StatefulWidget {
  WebglMaterialsBrowser({Key? key, required this.fileName}) : super(key: key);
...
class _MyAppState extends State<WebglMaterialsBrowser> {
  ...
  Future<void> initPage() async {
    ...
    // texture
    final geometry = three.TorusKnotGeometry(10, 3, 200, 32).toNonIndexed();
    final material =
        three.MeshPhysicalMaterial({"color": 0xff0abb, "roughness": 0});
