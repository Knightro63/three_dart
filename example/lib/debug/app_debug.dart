...
class AppDebug extends StatefulWidget {
  AppDebug({Key? key, required this.fileName}) : super(key: key);
  final String fileName;
  @override
  createState() => webgl_debugState();
}

class webgl_debugState extends State<AppDebug> {
  @override
  void initState() {
    super.initState();
  }
  ...
  clickRender() {
    ...
    var values = [
      ...
      0.827555239200592,
      -0.5613213777542114,
      -0.004157633055001497,
      -0.007904959842562675,
      0.7461036443710327,
      -0.6657804846763611,
      -0.0033440093975514174,
      -0.009084964171051979,
      0.6201450824737549,
      -0.7844299674034119,
      -0.0022029252722859383,
      -0.009808935225009918,
      0.5117224454879761,
      -0.8590943813323975,
      -0.0012874591629952192,
