...
class WebglHelpers extends StatefulWidget {
  WebglHelpers({Key? key, required this.fileName}) : super(key: key);
...
class _State extends State<WebglHelpers> {
  ...
  Future<void> initPage() async {
    ...
    final gridHelper = three.GridHelper(400, 40, 0x0000ff, 0x808080);
    gridHelper.position.y = -150;
    gridHelper.position.x = -150;
    scene.add(gridHelper);

    final polarGridHelper =
    ...
    final result = await loader.loadAsync('LeePerrySmith.gltf');
    loader.dispose();
    ...
    final wireframe = three.WireframeGeometry(mesh.geometry!);
    ...
    final edges = three.EdgesGeometry(mesh.geometry!, null);
